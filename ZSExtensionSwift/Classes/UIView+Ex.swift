...
extension UIView {
    ...
    ///   - distance: 缩进的距离
    /// - Returns: 得到的区域
    public func cutRect(direction: Direction, distance: CGFloat) ->  CGRect {
        switch direction {
        case .top:
    ...
    public func clickCorner(corners: UIRectCorner, cornerRadius: CGFloat) {
    ...
    public func addBorderTop(size: CGFloat, color: UIColor, padding: CGFloat) {
